...
const brandFilters: FilterOption[] = [
  { id: 'legrand', label: 'Legrand', count: 245 },
  { id: 'schneider', label: 'Schneider Electric', count: 189 },
  { id: 'abb', label: 'ABB', count: 156 },
  { id: 'hager', label: 'Hager', count: 98 },
  { id: 'gewiss', label: 'Gewiss', count: 76 },
  { id: 'schrack', label: 'Schrack', count: 64 },
  { id: 'eti', label: 'ETI', count: 52 },
  { id: 'vimar', label: 'Vimar', count: 45 },
]

const subcategoryFilters: FilterOption[] = [
  { id: 'prekidaci', label: 'Prekidači', count: 312 },
  { id: 'uticnice', label: 'Utičnice', count: 289 },
  { id: 'okviri', label: 'Okviri', count: 198 },
  { id: 'dimeri', label: 'Dimeri', count: 67 },
  { id: 'tasteri', label: 'Tasteri', count: 145 },
  { id: 'senzori', label: 'Senzori pokreta', count: 34 },
]
...
const mockProducts = [
  ...
  },
  {
    id: '2',
    sifra: '1848994',
    naziv: 'Schneider Sedna - Dvostruka utičnica s uzemljenjem, bijela',
  ...
  },
  {
    id: '3',
    sifra: '1849004',
    naziv: 'ABB Basic55 - Okvir jednostruki, bijeli',
    proizvodac: 'ABB',
    cijena: 2.15,
    staraCijena: 3.50,
    zaliha: 1204,
  ...
  },
  {
    id: '4',
    sifra: '1628899',
    naziv: 'Hager Berker S.1 - Serijski prekidač, antracit',
    proizvodac: 'HAGER',
    cijena: 15.80,
    zaliha: 89,
    jedinica: 'kom',
  },
  {
    id: '5',
    sifra: '1561834',
    naziv: 'Gewiss Chorus - Utičnica 2P+E 16A s poklopcem, IP44',
    proizvodac: 'GEWISS',
    cijena: 9.75,
    staraCijena: 14.20,
    zaliha: 167,
  ...
  },
  {
    id: '7',
    sifra: '1751234',
    naziv: 'Schneider Unica - Trostruki okvir, aluminij',
    proizvodac: 'SCHNEIDER',
    cijena: 8.90,
    zaliha: 0,
    jedinica: 'kom',
  },
  {
    id: '8',
    sifra: '1891245',
    naziv: 'ABB Zenit - Utičnica za shuko, srebrna',
    proizvodac: 'ABB',
    cijena: 18.50,
    staraCijena: 22.00,
    zaliha: 78,
  ...
  },
  {
    id: '9',
    sifra: '1934521',
    naziv: 'Vimar Plana - Tipkalo za svjetlo, bijelo',
    proizvodac: 'VIMAR',
    cijena: 6.20,
    zaliha: 523,
    jedinica: 'kom',
  },
  {
    id: '10',
    sifra: '1823456',
    naziv: 'Legrand Celiane - Senzor pokreta 180°, bijeli',
    proizvodac: 'LEGRAND',
    cijena: 52.30,
    zaliha: 12,
    jedinica: 'kom',
  },
  {
    id: '11',
    sifra: '1756789',
    naziv: 'Schrack Visio 50 - Jednopolni prekidač, bijeli',
    proizvodac: 'SCHRACK',
    cijena: 4.50,
    zaliha: 890,
    jedinica: 'kom',
  },
  {
    id: '12',
    sifra: '1698745',
    naziv: 'ETI KZS - Utičnica nadžbukna IP54, siva',
    proizvodac: 'ETI',
    cijena: 7.80,
    staraCijena: 9.90,
    zaliha: 234,
...
export default function CategoryPage() {
  ...
  const activeFiltersCount = selectedBrands.length + selectedSubcategories.length + (inStockOnly ? 1 : 0)
        ...
        <div className="mx-auto max-w-7xl px-[var(--spacing-container-padding)] py-6 lg:py-8">
          ...
          <div className="mb-6 lg:mb-8">
            ...
            <p className="mt-2 text-[var(--color-text-secondary)] max-w-3xl">
              Pronađite kvalitetne prekidače, utičnice i okvire vodećih svjetskih proizvođača.
              Modularni sistemi za svaki interijer i svaku primjenu.
            </p>
          </div>
              ...
              {activeFiltersCount > 0 && (
                <div className="mb-4 flex flex-wrap items-center gap-2">
                  ...
                  {selectedBrands.map(brandId => {
                    const brand = brandFilters.find(b => b.id === brandId)
                    return brand ? (
                      <button
                        key={brandId}
                  ...
                  {selectedSubcategories.map(subcatId => {
                    const subcat = subcategoryFilters.find(s => s.id === subcatId)
                    return subcat ? (
                      <button
                        key={subcatId}
