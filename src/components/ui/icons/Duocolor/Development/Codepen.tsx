...
const SvgCodepen = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="m12 9-7.936 5.159c-.688.447-1.032.67-1.151.954a1 1 0 0 0 0 .774M12 9l7.936 5.159c.688.447 1.032.67 1.151.954a1 1 0 0 1 0 .774M12 9V2.5"
      opacity={0.4}
    />
    <path
      stroke="currentColor"
