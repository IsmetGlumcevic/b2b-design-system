...
const SvgYoutube = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9.75 9.465c0-.477 0-.716.1-.849a.5.5 0 0 1 .364-.199c.166-.012.367.117.769.375l3.942 2.535c.349.224.523.336.583.478a.5.5 0 0 1 0 .39c-.06.142-.234.254-.583.478l-3.942 2.534c-.402.259-.603.388-.769.376a.5.5 0 0 1-.364-.2c-.1-.132-.1-.371-.1-.848z"
    />
  </svg>
);
