...
const SvgBeaker02 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M18.5 17h-13c-.465 0-.697 0-.89.038a2 2 0 0 0-1.572 1.572C3 18.803 3 19.035 3 19.5s0 .697.038.89a2 2 0 0 0 1.572 1.572c.193.038.425.038.89.038h13c.465 0 .697 0 .89-.038a2 2 0 0 0 1.572-1.572c.038-.193.038-.425.038-.89s0-.697-.038-.89a2 2 0 0 0-1.572-1.572C19.197 17 18.965 17 18.5 17"
    />
  </svg>
);
