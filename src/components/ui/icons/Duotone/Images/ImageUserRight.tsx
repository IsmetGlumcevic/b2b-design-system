...
const SvgImageUserRight = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="currentColor" opacity={0.12}>
      <path d="M10 13.5a4 4 0 1 0 0-8 4 4 0 0 0 0 8M18 22c0-.93 0-1.394-.077-1.78a4 4 0 0 0-3.143-3.143C14.394 17 13.93 17 13 17H6a4 4 0 0 0-3.854 2.926A3 3 0 0 0 5 22z" />
    </g>
    <path
      stroke="currentColor"
      strokeLinecap="round"
