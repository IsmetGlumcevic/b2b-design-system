...
const SvgTrain = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M4 12h16v2.2c0 1.68 0 2.52-.327 3.162a3 3 0 0 1-1.311 1.311C17.72 19 16.88 19 15.2 19H8.8c-1.68 0-2.52 0-3.162-.327a3 3 0 0 1-1.311-1.311C4 16.72 4 15.88 4 14.2z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
