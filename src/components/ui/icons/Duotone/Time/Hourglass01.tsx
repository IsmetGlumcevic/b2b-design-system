...
const SvgHourglass01 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M6 19.248V22h12v-2.752c0-.826 0-1.24-.103-1.622a3 3 0 0 0-.444-.947c-.228-.325-.545-.59-1.18-1.118L12 12l-4.273 3.56c-.635.53-.952.794-1.18 1.119a3 3 0 0 0-.444.947C6 18.009 6 18.422 6 19.248"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
