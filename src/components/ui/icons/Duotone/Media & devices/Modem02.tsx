...
const SvgModem02 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M2 18.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C3.52 15 4.08 15 5.2 15h13.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C22 16.52 22 17.08 22 18.2v.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C20.48 22 19.92 22 18.8 22H5.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C2 20.48 2 19.92 2 18.8z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
