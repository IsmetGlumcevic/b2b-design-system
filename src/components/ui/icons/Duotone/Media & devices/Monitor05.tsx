...
const SvgMonitor05 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M12 7.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C13.52 4 14.08 4 15.2 4h3.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C22 5.52 22 6.08 22 7.2v9.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C20.48 20 19.92 20 18.8 20h-3.6c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C12 18.48 12 17.92 12 16.8z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
