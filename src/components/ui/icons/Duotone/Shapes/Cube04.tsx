...
const SvgCube04 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M14.4 8H4.6c-.56 0-.84 0-1.054.109a1 1 0 0 0-.437.437C3 8.76 3 9.04 3 9.6v9.8c0 .56 0 .84.109 1.054a1 1 0 0 0 .437.437C3.76 21 4.04 21 4.6 21h9.8c.56 0 .84 0 1.054-.109a1 1 0 0 0 .437-.437C16 20.24 16 19.96 16 19.4V9.6c0-.56 0-.84-.109-1.054a1 1 0 0 0-.437-.437C15.24 8 14.96 8 14.4 8"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
