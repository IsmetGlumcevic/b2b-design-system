...
const SvgMessageHeartCircle = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12.497 8.95c-.9-1.04-2.4-1.319-3.527-.368s-1.286 2.542-.401 3.667c.548.697 1.925 1.97 2.893 2.838.356.319.534.478.747.542.183.055.393.055.576 0 .214-.064.391-.223.747-.542.968-.868 2.345-2.14 2.893-2.838a2.606 2.606 0 0 0-.4-3.667c-1.147-.941-2.628-.672-3.528.367"
      clipRule="evenodd"
    />
  </svg>
);
