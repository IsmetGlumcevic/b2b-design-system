...
const SvgMessageQuestionCircle = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeWidth={2}
      d="M10.5 9.002a2.248 2.248 0 0 1 4.37.75C14.87 11.25 12.62 12 12.62 12m.029 3h.01m-.16 5a8.5 8.5 0 1 0-8.057-5.783c.109.32.163.481.173.604a.9.9 0 0 1-.028.326c-.03.12-.098.245-.233.494L2.72 18.668c-.234.432-.35.648-.324.815a.5.5 0 0 0 .233.35c.144.087.388.062.877.011l5.12-.529c.156-.016.233-.024.304-.021s.119.009.186.024c.07.016.156.05.33.116A8.5 8.5 0 0 0 12.5 20"
    />
  </svg>
);
