...
const SvgBrush02 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M6 10h12v.2c0 1.68 0 2.52-.327 3.162a3 3 0 0 1-1.311 1.311c-.45.23-.997.298-1.862.318V19.5a2.5 2.5 0 0 1-5 0v-4.509c-.865-.02-1.412-.089-1.862-.318a3 3 0 0 1-1.311-1.311C6 12.72 6 11.88 6 10.2z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
