...
const SvgCodepen = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M12.872 9.567c-.316-.205-.473-.308-.643-.348a1 1 0 0 0-.457 0c-.17.04-.328.143-.644.348l-7.064 4.591c-.688.447-1.032.671-1.151.955a1 1 0 0 0 0 .774c.12.284.463.507 1.15.954l7.065 4.592c.316.205.473.308.643.348a1 1 0 0 0 .457 0c.17-.04.328-.143.644-.348l7.064-4.591c.688-.448 1.032-.671 1.151-.955a1 1 0 0 0 0-.774c-.12-.284-.463-.508-1.15-.955z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
