...
const SvgMicroscope = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M9.5 13h-4c-.465 0-.697 0-.89.038a2 2 0 0 0-1.572 1.572C3 14.803 3 15.035 3 15.5s0 .697.038.89a2 2 0 0 0 1.572 1.572c.193.038.425.038.89.038h4c.465 0 .697 0 .89-.038a2 2 0 0 0 1.572-1.572c.038-.193.038-.425.038-.89s0-.697-.038-.89a2 2 0 0 0-1.572-1.572C10.197 13 9.965 13 9.5 13"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
