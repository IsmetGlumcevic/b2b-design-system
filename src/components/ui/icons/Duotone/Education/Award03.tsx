...
const SvgAward03 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M7.869 15.46 7 22l4.588-2.753c.15-.09.225-.135.305-.152a.5.5 0 0 1 .214 0c.08.017.155.062.305.152L17 22l-.868-6.543-.25.602a1.525 1.525 0 0 1-1.991.825l-1.308-.542a1.52 1.52 0 0 0-1.166 0l-1.31.542a1.524 1.524 0 0 1-1.99-.824z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
