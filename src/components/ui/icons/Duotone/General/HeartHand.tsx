...
const SvgHeartHand = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M17.191 3.592c-.596-1.249-1.972-1.91-3.31-1.272-1.339.639-1.909 2.153-1.348 3.483s2.81 4.685 2.81 4.685 3.628-1.78 4.778-2.652a2.66 2.66 0 0 0 .574-3.69c-.861-1.217-2.362-1.337-3.504-.554"
      clipRule="evenodd"
      opacity={0.12}
    />
    <path
