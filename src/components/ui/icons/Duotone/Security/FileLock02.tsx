...
const SvgFileLock02 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M14 18.6c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C14.76 17 15.04 17 15.6 17h3.8c.56 0 .84 0 1.054.109a1 1 0 0 1 .437.437C21 17.76 21 18.04 21 18.6v.8c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437C20.24 21 19.96 21 19.4 21h-3.8c-.56 0-.84 0-1.054-.109a1 1 0 0 1-.437-.437C14 20.24 14 19.96 14 19.4z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
