...
const SvgBuilding07 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="currentColor" opacity={0.12}>
      <path d="M3 12.6c0-.56 0-.84.109-1.054a1 1 0 0 1 .437-.437C3.76 11 4.04 11 4.6 11h2.9v10H3zM16.5 11h2.9c.56 0 .84 0 1.054.109a1 1 0 0 1 .437.437C21 11.76 21 12.04 21 12.6V21h-4.5z" />
    </g>
    <path
      stroke="currentColor"
      strokeLinecap="round"
