...
const SvgHearts = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M16.297 11.75c-.422-2.268-2.352-3.927-4.781-3.476-2.43.451-4.001 2.643-3.673 5.025s2.505 8.755 2.505 8.755 6.608-1.302 8.835-2.208 3.376-3.362 2.515-5.693-3.226-3.171-5.4-2.403"
      clipRule="evenodd"
      opacity={0.12}
    />
    <path
