...
const SvgHand = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M12 22c4.694 0 8.5-3.731 8.5-8.333V8.11c0-.92-.761-1.667-1.7-1.667s-1.7.747-1.7 1.667V4.778c0-.92-.761-1.667-1.7-1.667s-1.7.746-1.7 1.667V3.667C13.7 2.747 12.939 2 12 2s-1.7.746-1.7 1.667v1.11c0-.92-.761-1.666-1.7-1.666s-1.7.746-1.7 1.667v6.666c0-.92-.761-1.666-1.7-1.666s-1.7.746-1.7 1.666v2.223C3.5 18.269 7.306 22 12 22"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
