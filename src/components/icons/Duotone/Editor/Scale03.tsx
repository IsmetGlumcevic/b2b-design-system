...
const SvgScale03 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M12 6.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C13.52 3 14.08 3 15.2 3h1c1.68 0 2.52 0 3.162.327a3 3 0 0 1 1.311 1.311C21 5.28 21 6.12 21 7.8v1c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C19.48 12 18.92 12 17.8 12h-2.6c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C12 10.48 12 9.92 12 8.8z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
