...
const SvgInbox01 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M15.033 4H8.967C7.89 4 7.35 4 6.876 4.164a3 3 0 0 0-1.121.693c-.36.352-.6.833-1.082 1.796L2 12h3.882c.685 0 1.312.387 1.618 1s.933 1 1.618 1h5.764c.685 0 1.312-.387 1.618-1s.933-1 1.618-1H22l-2.673-5.347c-.482-.963-.723-1.444-1.082-1.796a3 3 0 0 0-1.12-.693C16.648 4 16.11 4 15.032 4"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
