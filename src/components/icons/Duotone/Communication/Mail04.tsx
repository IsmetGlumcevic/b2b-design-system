...
const SvgMail04 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M10.256 13.366 2 8l8.256-5.367c.631-.41.947-.615 1.287-.695a2 2 0 0 1 .914 0c.34.08.656.285 1.287.695L22 8l-8.256 5.366c-.631.41-.947.616-1.287.696-.3.07-.613.07-.914 0-.34-.08-.656-.285-1.287-.696"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
