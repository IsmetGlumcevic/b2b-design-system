...
const SvgScales01 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="currentColor" opacity={0.12}>
      <path d="M6 21a4 4 0 0 0 4-4v-.2c0-.28 0-.42-.055-.527a.5.5 0 0 0-.218-.218C9.62 16 9.48 16 9.2 16H2.8c-.28 0-.42 0-.527.055a.5.5 0 0 0-.219.218C2 16.38 2 16.52 2 16.8v.2a4 4 0 0 0 4 4M18 19a4 4 0 0 0 4-4v-.2c0-.28 0-.42-.055-.527a.5.5 0 0 0-.218-.218C21.62 14 21.48 14 21.2 14h-6.4c-.28 0-.42 0-.527.055a.5.5 0 0 0-.218.218C14 14.38 14 14.52 14 14.8v.2a4 4 0 0 0 4 4" />
    </g>
    <path
      stroke="currentColor"
      strokeLinecap="round"
