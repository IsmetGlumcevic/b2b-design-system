...
const SvgAward04 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="currentColor" opacity={0.12}>
      <path d="M4 5.2v.677c0 .416 0 .624.04.823a2 2 0 0 0 .179.508c.092.181.222.343.482.668l4.175 5.22A5 5 0 0 1 12 12L4.522 2.652a2 2 0 0 0-.304.44C4 3.52 4 4.08 4 5.2M20 5.2v.677c0 .416 0 .624-.04.823a2 2 0 0 1-.179.508c-.092.181-.222.343-.482.668l-4.175 5.22A5 5 0 0 0 12 12l7.478-9.348a2 2 0 0 1 .304.44C20 3.52 20 4.08 20 5.2" />
    </g>
    <path
      stroke="currentColor"
      strokeLinecap="round"
