...
const SvgWatchSquare = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="currentColor" opacity={0.12}>
      <path d="M13.586 22h-3.172c-.865 0-1.298 0-1.662-.148a2 2 0 0 1-.816-.616c-.243-.309-.361-.725-.6-1.557L7 18.5h10l-.337 1.18c-.238.831-.356 1.247-.6 1.556a2 2 0 0 1-.815.616c-.364.148-.796.148-1.662.148M16.663 4.32c-.238-.831-.356-1.247-.6-1.556a2 2 0 0 0-.815-.616C14.884 2 14.452 2 13.586 2h-3.172c-.865 0-1.298 0-1.662.148a2 2 0 0 0-.816.616c-.243.309-.361.725-.6 1.557L7 5.5h10z" />
    </g>
    <path
      stroke="currentColor"
      strokeLinecap="round"
