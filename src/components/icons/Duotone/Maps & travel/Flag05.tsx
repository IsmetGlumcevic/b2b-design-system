...
const SvgFlag05 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M12.545 15.167h7.595c.448 0 .671 0 .802-.094a.5.5 0 0 0 .205-.348c.019-.16-.09-.356-.307-.747l-1.47-2.645c-.079-.142-.118-.213-.133-.288a.5.5 0 0 1 0-.201c.015-.075.054-.146.133-.288l1.47-2.645c.217-.391.326-.587.307-.747a.5.5 0 0 0-.205-.348c-.13-.094-.354-.094-.802-.094h-6.029v2.622c0 .56 0 .84-.109 1.054a1 1 0 0 1-.437.437c-.214.11-.494.11-1.054.11h-1.566v2.622c0 .56 0 .84.108 1.054a1 1 0 0 0 .438.437c.213.109.493.109 1.053.109"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
