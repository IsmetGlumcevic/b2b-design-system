...
const SvgPlaySquare = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M9.5 8.965c0-.477 0-.715.1-.849a.5.5 0 0 1 .364-.199c.166-.012.367.117.769.376l4.72 3.034c.349.224.523.336.583.479a.5.5 0 0 1 0 .389c-.06.142-.234.254-.583.478l-4.72 3.035c-.402.258-.603.387-.769.375a.5.5 0 0 1-.364-.199c-.1-.133-.1-.372-.1-.85z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
