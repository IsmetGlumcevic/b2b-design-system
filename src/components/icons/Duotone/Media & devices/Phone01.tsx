...
const SvgPhone01 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="currentColor"
      d="M5 5.2c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C6.52 2 7.08 2 8.2 2h7.6c1.12 0 1.68 0 2.108.218a2 2 0 0 1 .874.874C19 3.52 19 4.08 19 5.2v13.6c0 1.12 0 1.68-.218 2.108a2 2 0 0 1-.874.874C17.48 22 16.92 22 15.8 22H8.2c-1.12 0-1.68 0-2.108-.218a2 2 0 0 1-.874-.874C5 20.48 5 19.92 5 18.8z"
      opacity={0.12}
    />
    <path
      stroke="currentColor"
