...
const SvgCar02 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M19 10V6.2c0-1.12 0-1.68-.218-2.108a2 2 0 0 0-.874-.874C17.48 3 16.92 3 15.8 3H8.2c-1.12 0-1.68 0-2.108.218a2 2 0 0 0-.874.874C5 4.52 5 5.08 5 6.2V10m0-1H2V8m17 1h3V8M6 13.5h.01m11.99 0h.01m-11.51 0a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0m12 0a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0"
      opacity={0.4}
    />
    <path
      stroke="currentColor"
