...
const SvgPackageSearch = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="m22 21.5-1-1m1-2.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0"
    />
  </svg>
);
