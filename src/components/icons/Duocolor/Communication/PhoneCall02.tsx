...
const SvgPhoneCall02 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M4.859 6A9.97 9.97 0 0 1 12 3a9.97 9.97 0 0 1 7.142 3m-2.67 3A5.99 5.99 0 0 0 12 7a5.99 5.99 0 0 0-4.472 2"
      opacity={0.4}
    />
    <path
      stroke="currentColor"
