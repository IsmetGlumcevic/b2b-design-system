...
const SvgTool02 = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="m6 6 4.5 4.5M6 6H3L2 3l1-1 3 1zm6 9 5.5 5.5a2.121 2.121 0 0 0 3-3l-4.525-4.525a5.5 5.5 0 0 1-.934-.17c-.39-.107-.816-.03-1.101.255z"
      opacity={0.4}
    />
    <path
      stroke="currentColor"
